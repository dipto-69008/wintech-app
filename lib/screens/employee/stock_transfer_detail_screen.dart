      ...
      body: ListView(
        ...
        children: [
          ...
          _section(
            ...
            child: Column(
              children: [
                _infoRow('From Zone', _text('fromZoneName').isNotEmpty ? _text('fromZoneName') : _text('fromBranch')),
                _infoRow('To Zone', _text('toZoneName').isNotEmpty ? _text('toZoneName') : _text('toBranch')),
